...
@io.swagger.v3.oas.annotations.media.Schema(description = "User Registration Request Payload")
public class RegisterRequest {

    @NotBlank(message = "Full name is required")
    @Size(min = 3, max = 100, message = "Full name must be between 3 and 100 characters")
    @io.swagger.v3.oas.annotations.media.Schema(description = "User's full legal name", example = "John Doe")
    private String fullName;

    @NotBlank(message = "Email is required")
    @Email(message = "Please enter a valid email")
    @io.swagger.v3.oas.annotations.media.Schema(description = "Unique user email address", example = "john.doe@example.com")
    ...
    @io.swagger.v3.oas.annotations.media.Schema(description = "Account password matching security rules", example = "BloodBridge@2026")
    private String password;

    @NotBlank(message = "Phone number is required")
    @io.swagger.v3.oas.annotations.media.Schema(description = "Contact phone number", example = "+1234567890")
    private String phoneNumber;

    @NotNull(message = "Role is required")
    @io.swagger.v3.oas.annotations.media.Schema(description = "Primary user role (DONOR, PATIENT, HOSPITAL, ADMIN)", example = "DONOR")
    private Role role;
