...
public class EmailDebugController {
    ...
    public ResponseEntity<Map<String, Object>> sendTestEmail(
            @RequestParam(required = false, defaultValue = "insurai2@gmail.com") String to,
        ...
        try {
            ...
            String safeSender = mailUsername != null && !mailUsername.isBlank() ? mailUsername : "insurai2@gmail.com";
